...
const stories = [
  {
    ...
    excerpt:
      "Explore the emotional journey of a mother's sacrifices, shaping generations with her unconditional love and wisdom.",
    category: "Stories",
  ...
  },
  {
    ...
    excerpt:
      "Being a mom is a full-time job. Discover simple ways mothers can nourish their mind, body, and soul every day.",
    category: "Health",
  ...
  },
  {
    ...
    excerpt:
      "Meet mothers who turned everyday struggles into extraordinary stories of courage, leadership, and hope.",
      ...
      <div className="w-full h-screen relative z-0">
        ...
        <div className="h-fit md:w-[45vw] lg:w-[40vw] w-[65vw] bg-white text-black absolute bottom-0 left-[10vw]">
          ...
          <div className="h-full md:p-10 p-8 flex flex-col lg:gap-5 gap-4">
            <h5 className="text-sm md:text-xs lg:text-base font-semibold lowercase">
              #{story.category}
            </h5>
          ...
          <div className=" lg:w-1/3 w-full h-fit flex flex-col gap-10 md:mt-0 mt-28">
            <div className="border-[1px] border-black max-h-[50vh] w-full relative text-center pt-20 pb-10 px-5 flex flex-col gap-3">
              ...
              <h5 className="text-zinc-500">
                A passionate frontend developer and storyteller. I created this
                blog as a heartfelt space to honor the love, resilience, and
                inspiration that mothers bring into our lives.I aim to craft
